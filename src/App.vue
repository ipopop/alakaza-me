<template>
  <div id="app">
    <div class="flex bg-gray-100">
      <div
        class="max-w-md px-8 py-4 mx-auto sm:py-12 sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12"
      >
        <div class="xl:max-w-lg xl:ml-auto">
          <img class="h-10" src="img/logo.svg" alt="Workcation" />
          <img
            class="object-cover object-center w-full h-48 mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:object-cover lg:hidden"
            src="img/beach-work.jpg"
            alt="Woma Workcationing on the beach"
          />
          <h2
            class="mt-6 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl sm:mt-8 lg:text-3xl"
          >
          ...
          <div class="mt-4 sm:mt-6">
            <a href="#" class="shadow-lg btn btn-indigo sm:text-base"
              >Book your escape</a
            >
