...
<div id="app">
    ...
    <section id="header" class="flex bg-white">
        <div class="max-w-md px-8 py-4 mx-auto sm:py-12 sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
            <div class="xl:max-w-lg xl:ml-auto">
                ...
                <div class="text-center sm:text-left my-8 sm:mt-6 sm:text-base xl:mt-10 xl:text-sm">
                    <a href="#" class="mb-6 shadow-lg btn btn-indigo w-full sm:w-auto">Book your escape</a>
                    <br class="sm:hidden inline" />
                    <a href="#dest" class="w-full sm:w-auto sm:ml-4 btn btn-gray">Learn more</a>
                </div>
            </div>
        </div>
        <div class="hidden lg:block lg:w-1/2 lg:relative">
            <img class="absolute inset-0 object-cover object-center w-full h-full" src="img/beach-work.jpg" alt="Woma Workcationing on the beach" />
        </div>
    </section>
    <section id="cards">
        <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center max-w-md px-8 py-8 mx-auto sm:max-w-xl lg:max-w-6xl lg:px-12">
            <h2 id="dest" class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Popular destinations</h2>
            <p class="lg:w-1/2 w-full leading-relaxed text-base text-gray-600">
                A selection of great work-friendly cities with lots to see and
                explore.
            </p>
            <div class="flex flex-wrap text-center">
                <div class="object-center mx-auto max-w-350 min-h-300 sm:max-w-450 px-4 mt-10" v-for="destination in popularDestinations" v-bind:key="destination">
                    <DestinationCard :destination="destination" />
                </div>
            </div>
        </div>
    </section>
    <section id="content" class="bg-white text-gray-700 body-font">
    ...
    <section id="stats" class="bg-white text-gray-700 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Master Cleanse Reliac Heirloom</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac humblebrag.</p>
    ...
    <section id="pricing" class="text-gray-700 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <div class="flex mx-auto border-2 border-indigo-500 rounded overflow-hidden mt-6">
                    ...
                    <button class="py-1 px-4 bg-white focus:outline-none">Annually</button>
                </div>
            </div>
            <div class="flex flex-wrap -m-4">
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="bg-white h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="bg-white h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
    ...
    <section id="testimonial" class="bg-white text-gray-700 body-font">
        <div class="container px-5 py-24 mx-auto">
    ...
    <section id="contact" class="bg-white text-gray-700 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                        <a class="text-indigo-500">contact@alakaza.me</a>
